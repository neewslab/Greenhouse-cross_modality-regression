# -*- coding: utf-8 -*-
"""
Created on Tue Jan 16 22:43:52 2024
...
# X_,y_ =data_con[0:60000, 1:2], data_con[0:60000, 0:1]
...
plt.ylabel('loss')
plt.xlabel('Eepoch')
plt.ylim(np.min(history.history['loss'])-10,50000)
...
X__,y__ =data_con[60000:70000, 1], data_con[60000:70000, 2]
...
pred_PAR = model.predict(data_voltage)
dataset_new = np.append(dataset[1:,],pred_PAR, axis =1)


model.save("Regression_Model_Greenhouse\PAR_pred_model.h5")